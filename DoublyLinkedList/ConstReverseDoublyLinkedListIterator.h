...
//you must implement at least the methods below
  ...
  //more members and methods
	ConstReverseDoublyLinkedListIterator(DoubleLinkedNode<T> *p =nullptr):m_ptr(p){}
  //copy constructor
  ConstReverseDoublyLinkedListIterator(const ConstReverseDoublyLinkedListIterator& orig){m_ptr = orig.m_ptr;}
